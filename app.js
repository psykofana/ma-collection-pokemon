...
async function submitLogin() {
  ...
  setAdminMode(true);   // ← forçage manuel immédiat, l'événement onAuthStateChange de Supabase gèrera la suite  
  closeLoginModal();
}
/* ============================================================
   FILTERS
